...
\subsection*{Automated Database Schema Migration}
\begin{table}[H]
\centering
\begin{tabular}{p{4cm} p{10cm}}
\toprule
\textbf{Task} & \textbf{Description} \\
\midrule
\texttt{DE-1223} & automated-database-schema-migrations \\
\bottomrule
\end{tabular}
\end{table}
...
Sirketin Talentlms hesabi uzerinden, tum sirketin katilim sagladigi Iso 27001 egitimi sonrasinda tekrardan bir test ile "allgemeine Datenschutzschulung belgesi aldim. 
